...
<head>
    ...
    <meta name="description" content="Official Shareholder Information, Share Registrar details, Election of Directors 2026, SECP Complaint Portal, Unclaimed Dividend, and Statutory Registers for Shakarganj Limited (SML).">
...
<body>
    ...
    <section style="background: linear-gradient(135deg, #003318, #005a2b); padding: 2.25rem 0 2.5rem; color: #ffffff; text-align: center;">
        <div class="container">
            ...
            <p style="font-size: 1rem; color: rgba(255,255,255,0.88); max-width: 720px; margin: 0 auto; line-height: 1.5;">Essential statutory information, share registrar contact, election of directors, and compliance registers for Shakarganj Limited shareholders.</p>
        </div>
    </section>

    <!-- Interactive Navigation Tabs Section -->
    <section style="padding: 2rem 0 4rem; background-color: var(--bg-main);">
        <div class="container">
            
            <!-- Category Tabs Selector -->
            <div style="display: flex; justify-content: center; gap: 0.75rem; flex-wrap: wrap; margin-bottom: 2rem;" id="shareholderTabButtons">
                <button class="sh-tab-btn active" onclick="switchShTab('contact')">Investor Contact & Share Registrar</button>
                <button class="sh-tab-btn" onclick="switchShTab('election')">Election of Directors 2026</button>
                <button class="sh-tab-btn" onclick="switchShTab('listing')">Stock Exchange Listing</button>
                <button class="sh-tab-btn" onclick="switchShTab('registers')">Policies & Statutory Registers</button>
                <button class="sh-tab-btn" onclick="switchShTab('advisors')">Advisors & Bankers</button>
            </div>

            <!-- Tab 1: Investor Contact & Share Registrar -->
            <div id="tab-contact" class="sh-tab-content active">
                <div style="text-align: center; margin-bottom: 2.5rem;">
                    <h2 class="sh-section-title">Investor Contact & Share Registrar</h2>
                    <p style="color: var(--text-muted); font-size: 1.05rem;">Direct contact information for corporate secretarial assistance and share transfer inquiries.</p>
                </div>
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(320px, 1fr)); gap: 2rem; margin-bottom: 3rem;">
                    ...
                    <div style="background: var(--bg-surface); border: 1px solid var(--border-color); border-radius: var(--radius-xl); padding: 2rem; box-shadow: var(--shadow-md); display: flex; flex-direction: column;">
                        <div style="display: flex; align-items: center; gap: 1rem; margin-bottom: 1.25rem;">
                            ...
                            <div>
                                <span style="font-size: 0.8rem; font-weight: 700; color: var(--primary); text-transform: uppercase; letter-spacing: 0.5px;">Corporate Office</span>
                        ...
                        <div style="display: flex; flex-direction: column; gap: 0.6rem; font-size: 0.95rem; color: var(--text-muted);">
                            <p style="margin: 0; display: flex; align-items: center; gap: 0.5rem;"><strong style="color: var(--text-main);">Email:</strong> <a href="mailto:asif.ali@shakarganj.com.pk" style="color: var(--primary); font-weight: 600; text-decoration: none;">asif.ali@shakarganj.com.pk</a></p>
                    ...
                    <div style="background: var(--bg-surface); border: 1px solid var(--border-color); border-radius: var(--radius-xl); padding: 2rem; box-shadow: var(--shadow-md); display: flex; flex-direction: column;">
                        <div style="display: flex; align-items: center; gap: 1rem; margin-bottom: 1.25rem;">
                            ...
                            <div>
                                <span style="font-size: 0.8rem; font-weight: 700; color: var(--primary); text-transform: uppercase; letter-spacing: 0.5px;">Share Transfer Agent</span>
                        ...
                        <div style="display: flex; flex-direction: column; gap: 0.6rem; font-size: 0.95rem; color: var(--text-muted);">
                            <p style="margin: 0; display: flex; align-items: center; gap: 0.5rem;"><strong style="color: var(--text-main);">Email:</strong> <a href="mailto:info@corptec.com.pk" style="color: var(--primary); font-weight: 600; text-decoration: none;">info@corptec.com.pk</a></p>
                ...
                <div style="background: linear-gradient(135deg, var(--bg-surface), var(--bg-alt)); border: 1px solid var(--border-color); border-radius: var(--radius-xl); padding: 2.25rem; box-shadow: var(--shadow-md);">
                    <div style="display: flex; align-items: center; justify-content: space-between; gap: 2rem; flex-wrap: wrap; margin-bottom: 1.5rem;">
                        <div style="display: flex; align-items: center; gap: 1.5rem; flex-wrap: wrap;">
                            ...
                            <div>
                                <h3 style="font-size: 1.4rem; color: var(--primary); font-weight: 800; margin-bottom: 0.25rem;">SECP Investor Complaint Portal (SDMS)</h3>
                    ...
                    <div style="background: rgba(0, 90, 43, 0.05); border-left: 4px solid var(--primary); padding: 1.25rem 1.5rem; border-radius: 0 var(--radius-md) var(--radius-md) 0; font-size: 0.925rem; color: var(--text-main); line-height: 1.6;">
                        <strong>SECP Redressal Guidance:</strong> In case your complaint has not been properly redressed by us, you may lodge your complaint with the Securities and Exchange Commission of Pakistan (the “SECP”). Please note that SECP entertains complaints which were first directly requested to be redressed by the company and the company has failed to redress the same within reasonable time.
                    </div>
                </div>
            </div>

            <!-- Tab 2: Election of Directors 2026 -->
            <div id="tab-election" class="sh-tab-content">
                <div style="text-align: center; margin-bottom: 2.5rem;">
                    ...
                    <div class="doc-card">
                        <div style="display: flex; align-items: center; gap: 1rem; margin-bottom: 1rem;">
                            ...
                            <div>
                                ...
                                <span class="doc-meta">Contact Secretary for Credentials</span>
                            </div>
                        </div>
                        <div class="doc-btn-group">
            ...
            <!-- Tab 3: Stock Exchange Listing -->
            <div id="tab-listing" class="sh-tab-content">
                <div style="text-align: center; margin-bottom: 2.5rem;">
            ...
            <!-- Tab 4: Policies & Statutory Registers -->
            <div id="tab-registers" class="sh-tab-content">
                <div style="text-align: center; margin-bottom: 2.5rem;">
                    <h2 class="sh-section-title">Policies & Statutory Registers</h2>
                    <p style="color: var(--text-muted); font-size: 1.05rem;">Corporate governance policies, code of conduct, unclaimed dividend records, and SECP compliance statements.</p>
                </div>
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(300px, 1fr)); gap: 1.5rem;">
                    ...
                    <div class="doc-card">
                        <div style="display: flex; align-items: center; gap: 1rem; margin-bottom: 1rem;">
                            <div class="doc-icon-box">PDF</div>
                            <div>
                                <h4 class="doc-title">Unclaimed Dividend Register</h4>
                                <span class="doc-meta">Detail of Pending Dividend 2023</span>
                            </div>
                        </div>
                        <div class="doc-btn-group">
                            <a href="/docs/shareholder/Detail-of-Pending-Dividend-2023.pdf" target="_blank" class="doc-btn primary" style="grid-column: span 2;">Download Pending Dividend List</a>
                        </div>
                    </div>
                    ...
                    <div class="doc-card">
                        <div style="display: flex; align-items: center; gap: 1rem; margin-bottom: 1rem;">
                            <div class="doc-icon-box">PDF</div>
                            <div>
                                <h4 class="doc-title">Code of Conduct</h4>
                                <span class="doc-meta">Corporate Ethical Guidelines</span>
                            </div>
                        </div>
                        <div class="doc-btn-group">
                            <a href="/docs/shareholder/Code-of-Conduct.pdf" target="_blank" class="doc-btn primary" style="grid-column: span 2;">Download Code of Conduct</a>
                        </div>
                    </div>
                    ...
                    <div class="doc-card">
                        <div style="display: flex; align-items: center; gap: 1rem; margin-bottom: 1rem;">
                            <div class="doc-icon-box">PDF</div>
                            <div>
                                <h4 class="doc-title">Policies Register</h4>
                                <span class="doc-meta">Board Approved Policy Framework</span>
                            </div>
                        </div>
                        <div class="doc-btn-group">
                            <a href="/docs/shareholder/Policies-Register.pdf" target="_blank" class="doc-btn primary" style="grid-column: span 2;">Download Policies Register</a>
                        </div>
                    </div>
                    ...
                    <div class="doc-card">
                        <div style="display: flex; align-items: center; gap: 1rem; margin-bottom: 1rem;">
                            <div class="doc-icon-box">PDF</div>
                            <div>
                                <h4 class="doc-title">Website Compliance Certificate</h4>
                                <span class="doc-meta">Certified Sep 2025</span>
                            </div>
                        </div>
                        <div class="doc-btn-group">
                            <a href="/docs/shareholder/Website_Compliance_Certificate_Sep_2025.pdf" target="_blank" class="doc-btn primary" style="grid-column: span 2;">Download Compliance Certificate</a>
                        </div>
                    </div>
                    ...
                    <div class="doc-card">
                        <div style="display: flex; align-items: center; gap: 1rem; margin-bottom: 1rem;">
                            <div class="doc-icon-box">PDF</div>
                            <div>
                                <h4 class="doc-title">Gender Pay Gap Statement</h4>
                                <span class="doc-meta">SECP Circular 10 of 2024</span>
                            </div>
                        </div>
                        <div class="doc-btn-group">
                            <a href="/docs/shareholder/Gende_Pay_Gap_Statement_2025.pdf" target="_blank" class="doc-btn primary" style="grid-column: span 2;">Download Pay Gap Statement</a>
                        </div>
                    </div>
            ...
            <!-- Tab 5: Advisors & Bankers -->
            <div id="tab-advisors" class="sh-tab-content">
                <div style="text-align: center; margin-bottom: 2.5rem;">
    ...
    <style>
        ...
        .sh-tab-btn.active, .sh-tab-btn:hover {
    ...
    <script>
        function switchShTab(tabId) {
            document.querySelectorAll('.sh-tab-btn').forEach(btn => btn.classList.remove('active'));
...
print("Created shareholders-information.html page across all target directories!")
