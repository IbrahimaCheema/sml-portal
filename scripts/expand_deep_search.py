deep_index_js = """        const SITE_INDEX = [
            ...
            { title: 'Biofuels & Renewable Energy Division', category: 'Division', url: 'divisions.html#biofuel', desc: '150,000 L/day fuel-grade bio-ethanol distillery and green co-generation power.' },
...
print("Expanded deep page content and director names indexing across all index files!")
